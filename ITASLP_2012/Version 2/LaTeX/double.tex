...
Since acoustic multichannel equalization techniques generally design reshaping filters disregarding the presence of noise, in the following it is assumed that $v_m(n) = 0$ and $y_m(n) = x_m(n)$.
...
\includegraphics[scale = 0.6]{Plots/EDC_noreg_sys_3_Cm_-33_Ld_800}
}
\subfloat[\label{fig: edcnoreg33b}]{%
\includegraphics[scale = 0.6]{Plots/EDC_reg_sys_3_Cm_-33_Ld_800}
}}
...
\includegraphics[scale = 0.6]{Plots/PESQ_noreg_sys_3_error_-33}
}
\subfloat[\label{fig: pesq33b}]{%
\includegraphics[scale = 0.6]{Plots/PESQ_reg_sys_3_error_-33}
}}
...
\includegraphics[scale = 0.6]{Plots/EDC_noreg_sys_3_Cm_-15_Ld_800}
}
\subfloat[\label{fig: edcnoreg15b}]{%
\includegraphics[scale = 0.6]{Plots/EDC_reg_sys_3_Cm_-15_Ld_800}
}}
...
\includegraphics[scale = 0.6]{Plots/PESQ_noreg_sys_3_error_-15}
}
\subfloat[\label{fig: pesq15b}]{%
\includegraphics[scale = 0.6]{Plots/PESQ_reg_sys_3_error_-15}
}}
